        ...
        sql.eachRow(request) {
            ...
            if (it.id != lastAnnotationId) {
                ...
                if (al.columnToPrint.contains('group')) {
                    ...
                    annotationLinksIds.add(it.annotationLinks)
                }
                ...
                if (groupAsked && it.group && it.group == lastGroupId && !annotationLinksIds.contains(it.annotationLinks)) {
                    annotationLinksIds.add(it.annotationLinks)
